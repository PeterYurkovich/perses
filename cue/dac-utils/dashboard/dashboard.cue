...
import (
	"github.com/peteryurkovich/perses/cue/model/api/v1"
	v1Common "github.com/peteryurkovich/perses/cue/model/api/v1/common"
	v1Dashboard "github.com/peteryurkovich/perses/cue/model/api/v1/dashboard"
)
