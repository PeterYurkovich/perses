...
```golang
import txtVar "github.com/peteryurkovich/perses/go-sdk/variable/text-variable"
...
```golang
import listVar "github.com/peteryurkovich/perses/go-sdk/variable/text-variable"
